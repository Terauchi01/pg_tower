...
import { myPlayerId ,canvas ,ctx ,unitSize ,circleSize ,hpSize ,unitPointPos, buttonPos, buttonSize ,player ,castleSize ,enemy ,castleHpSize ,dragPos ,laneStartPos ,dragSize ,isDrag ,selectNum ,mousePos} from './data';
import { Player } from './player' ;
